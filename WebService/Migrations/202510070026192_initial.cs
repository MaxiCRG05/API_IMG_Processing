namespace WebService.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Proyectos_Categorias", "ProyectoID", "dbo.Proyectos");
            DropForeignKey("dbo.Proyectos_Categorias", "CategoriaID", "dbo.Categorias");
            ...
            DropIndex("dbo.Proyectos_Categorias", new[] { "CategoriaID" });
            DropIndex("dbo.Proyectos_Categorias", new[] { "ProyectoID" });
            ...
            DropTable("dbo.Proyectos_Categorias");
